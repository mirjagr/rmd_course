---
title: 'Journals: Random Words With Random Data ^[Preliminary draft. Please do not
  cite or circulate without permission from the author.]'
author: "'Jane Doe ^[Department of Science, University of Random. Email: jane.doe@random.edu."
...
library(stargazer)
# data
df_raw <- read.csv("C:/Users/Mirja/Desktop/R Kurs Markdown/rmd_workshop-master/data/journals.csv")
#df_raw <- read.csv("C../data/journals.csv")
...
<!-- figure 1 -->
```{r,  fig.cap="A screenshot of the Google Scholar homepage \\label{google}", out.width="40%", fig.align="center"}
...
stargazer(data = df, type = "latex", #if knitted to pdf then change type = "latex"
...
```{r, regression_table, echo=FALSE, results="asis", warning=FALSE}
